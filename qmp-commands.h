...
void qmp_stop_raw_live(Error **errp);
int qmp_marshal_input_stop_raw_live(Monitor *mon, const QDict *qdict, QObject **ret);
void qmp_iterate_raw_live(Error **errp);
int qmp_marshal_input_iterate_raw_live(Monitor *mon, const QDict *qdict, QObject **ret);
void qmp_randomize_raw_live(Error **errp);
int qmp_marshal_input_randomize_raw_live(Monitor *mon, const QDict *qdict, QObject **ret);
void qmp_unrandomize_raw_live(Error **errp);
